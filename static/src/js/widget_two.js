odoo.define('css_js.widget_two', function (require) {
"use strict";
    ...
    var WidgetTwo = AbstractField.extend({
        step: 1, // default value, if user not configure it in xml file
        template: 'WidgetTwoTemplate', // fill with the template name that will be rendered by odoo
    ...
    FieldRegistry.add('widget_two', WidgetTwo);
